...
## Описание
Проект реализован на языке программиования Python, использована библиотека PyGame. Содержит 4 базовых уровня, проходить которые можно в любом порядке. Использована современная красочная графика: 10 видов ящиков, 5 видов мест для установки ящиков, 4 кадра для движения игрока, 4 вида стен, 3 вида блока земли. Ведется подсчет сделанных ходов и после завершения уровня этот результат записывается в базу данных.
...
* *functions.py* - дополнительные функции, необходимые для функционирования проекта
