...
1. Зайдите на [страницу с актуальным релизом игры](https://github.com/Merlyan0/Sokoban/releases/tag/v1.0.1)
2. Скачайте файл *game.exe*, находящийся на этой странице
3. Запустите его
